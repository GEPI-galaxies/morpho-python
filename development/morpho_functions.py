...
def set_config_sex(galfiles, zp, config_file="default.sex", param_file="default.param", nnw_file="default.nnw", conv_file="default.conv"):
    ...
    modify_param(config_file, "CHECKIMAGE_TYPE", "SEGMENTATION")
    ...
    modify_param(config_file, "DETECT_THRESH", "1.0")
    modify_param(config_file, "ANALYSIS_THRESH", "1.0")
    modify_param(config_file, "DETECT_MINAREA", "10")
